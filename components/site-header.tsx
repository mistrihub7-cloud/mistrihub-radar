    ...
    <header className="sticky top-0 z-40 hidden border-b border-slate-200 bg-white/90 backdrop-blur md:block">
      <div className="container-page flex h-[74px] items-center justify-between gap-7">
        <div className="flex items-center gap-7">
          <Logo />
          <button className="flex h-11 items-center gap-2 rounded-lg border border-slate-200 bg-white px-4 text-sm font-bold text-slate-800">
        ...
        <div className="flex gap-4">
          ...
          <Link className="btn-primary w-24" href="/login">
            Register
          </Link>
        </div>
      </div>
